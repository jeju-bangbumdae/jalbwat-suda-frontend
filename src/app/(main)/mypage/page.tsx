...
export default function Page() {
  ...
  return (
    <>
      <TopBar height={'180px'} hasSetting />
      <ProfileModal>
        <ProfileImageContainer>
          <Image
            ...
            height={100}
            alt=""
            style={{ border: '2px solid var(--color-white)', borderRadius: '50px' }}
          />
        </ProfileImageContainer>
        <TextContainer>
          <Text typography="heading4" asChild>
            <h3 style={{ color: 'var(--color-gray-900)' }}>{'김구름'}</h3>
          </Text>
        </TextContainer>
